 ...
 * @author Dell
 */
public class DailyExpensesReportPage extends javax.swing.JFrame {
    ...
    public DailyExpensesReportPage() {
        initComponents();
    ...
    public void showInTable(String date) {
        ...
        int serial = 0;
        dailyExpenses = dailyExpenseDao.getAllDailyExpensesByDate(date);
...
//            V.add(customer.getCreation_date());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Daily Expenses Report");
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 125, -1, 30));
...
//        System.out.println(""+date);
    ...
    private void jButtonBack1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBack1ActionPerformed
        MessageFormat header = new MessageFormat("THE BEAUTY BAR REPORT Daily Expenses ");
...
//            options.setOutputFileName("C:\\Users\\Dell\\Desktop/TodaysReport" + ".pdf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DailyExpensesReportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DailyExpensesReportPage().setVisible(true);
            }
        });
    }
