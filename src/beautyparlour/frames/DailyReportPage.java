...
public class DailyReportPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableReport.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S#", "Custome Name", "Sale Date", "Total Bill"
            }
        ) {
        ...
        if (jTableReport.getColumnModel().getColumnCount() > 0) {
            ...
            jTableReport.getColumnModel().getColumn(3).setMinWidth(150);
            jTableReport.getColumnModel().getColumn(3).setPreferredWidth(150);
            jTableReport.getColumnModel().getColumn(3).setMaxWidth(150);
        }
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 150, -1, 20));
        ...
        jPanel1.add(jXDatePicker2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 150, -1, -1));
...
//        System.out.println(""+date);
    ...
    public void genReport(String date) {
        ...
        try {
            ...
            String rpath = "reportrptfiles/daily_customer_report.rptdesign";
...
//            options.setOutputFileName("C:\\Users\\Dell\\Desktop/TodaysReport" + ".pdf");
            options.setOutputFileName("Reports/Daily Customers/Report of date "+date+ ".pdf");
