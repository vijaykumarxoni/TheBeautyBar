 ...
 * @author Dell
 */
public class MonthlyExpensesReportPage extends javax.swing.JFrame {
    ...
    public MonthlyExpensesReportPage() {
        ...
        tableModelServiceReport = (DefaultTableModel) this.jTableExpenses.getModel();
        rowSorter = new TableRowSorter<DefaultTableModel>(tableModelServiceReport);

        this.jTableExpenses.setRowSorter(rowSorter);
    ...
    public void showInTable(String month,String year) {
        ...
        int serial = 0;
        dailyExpenses = dailyExpenseDao.getDailyExpenseByMonth(month,year);
...
//            V.add(customer.getCreation_date());
    ...
    private void initComponents() {
        ...
        totatCost = new javax.swing.JLabel();
        ...
        totatCost.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        totatCost.setForeground(new java.awt.Color(255, 255, 255));
        totatCost.setText("0");
        getContentPane().add(totatCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 541, -1, -1));
        ...
        jLabel1.setText("Monthly Expenses Report");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 60, -1, -1));

        jTableExpenses.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jTableExpenses.setToolTipText("Products");
        jTableExpenses.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jTableExpenses.setGridColor(new java.awt.Color(60, 34, 19));
        jTableExpenses.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                jTableExpensesMouseReleased(evt);
            }
        });
        jTableExpenses.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTableExpensesKeyReleased(evt);
            }
        });
        jScrollPane3.setViewportView(jTableExpenses);
        if (jTableExpenses.getColumnModel().getColumnCount() > 0) {
            jTableExpenses.getColumnModel().getColumn(0).setMinWidth(60);
            jTableExpenses.getColumnModel().getColumn(0).setPreferredWidth(60);
            jTableExpenses.getColumnModel().getColumn(0).setMaxWidth(60);
            jTableExpenses.getColumnModel().getColumn(1).setMinWidth(60);
            jTableExpenses.getColumnModel().getColumn(1).setPreferredWidth(60);
            jTableExpenses.getColumnModel().getColumn(1).setMaxWidth(60);
        }

        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 730, 350));
        ...
        jPanel1.add(jXDatePicker2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, -1, -1));
    ...
    private void jTableExpensesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableExpensesMouseReleased
        DailyExpenseBean deb = null;
        int id = Integer.parseInt(""
                + this.jTableExpenses.getValueAt(this.jTableExpenses.getSelectedRow(), 1));
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_jTableExpensesMouseReleased

    private void jTableExpensesKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTableExpensesKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_jTableExpensesKeyReleased
    ...
    private void jButtonBack1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBack1ActionPerformed
        ...
        try {
            this.jTableExpenses.print(JTable.PrintMode.FIT_WIDTH, header, footer);
...
//            options.setOutputFileName("C:\\Users\\Dell\\Desktop/TodaysReport" + ".pdf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyExpensesReportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonthlyExpensesReportPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel totatCost;
