 ...
 * @author Dell
 */
public class MonthlyReportPage extends javax.swing.JFrame {
    ...
    public void showInTable(String month, String year) {
        ...
        int serial = 0;
        daily_report_list = reportDao.getMonthlyReportBean(month, year);
...
//        System.out.println(""+date);
    ...
    public void genReport() {
        ...
        try {
            ...
            String rpath = "reportrptfiles/monthly_customer_report.rptdesign";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonthlyReportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
